...
/* Creating new schema and transfering all the tables into new schema */
CREATE SCHEMA axoncars;
CREATE TABLE axoncars.customers AS SELECT * FROM classicmodels.customers;
CREATE TABLE axoncars.employees AS SELECT * FROM classicmodels.employees;
CREATE TABLE axoncars.offices AS SELECT * FROM classicmodels.offices;
CREATE TABLE axoncars.orderdetails AS SELECT * FROM classicmodels.orderdetails;
CREATE TABLE axoncars.orders AS SELECT * FROM classicmodels.orders;
CREATE TABLE axoncars.payments AS SELECT * FROM classicmodels.payments;
CREATE TABLE axoncars.productlines AS SELECT * FROM classicmodels.productlines;
CREATE TABLE axoncars.products AS SELECT * FROM classicmodels.products;
DROP SCHEMA classicmodels;

USE AXONCARS;
-- Getting the details all the columns present in each tables--
